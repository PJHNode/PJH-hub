/* ============================================================
   ...
   ------------------------------------------------------------
   PJH Hub 관리자 콘솔.
   - Ctrl+Alt+M 또는 푸터의 Admin 버튼으로 모달 오픈
   - 비밀번호는 입력 즉시 서버(/verify)에서 검증함.
     틀리면 그 자리에서 에러만 표시하고 절대 다음 화면으로 넘어가지 않음.
   - 인증 성공 시에만 탭(공지 / 방 모니터링 / 설정) 접근 가능.
   - sessionStorage 에 인증된 비밀번호를 잠깐 보관 (탭 닫으면 사라짐).

   사용법: index.html 의 </body> 직전에
